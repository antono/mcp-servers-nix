...
## programs\.musescore\.enable

Whether to enable musescore\.
...
*Declared by:*
 - [\<mcp-servers-nix-plus/modules/servers/musescore\.nix>](https://github.com/antono/mcp-servers-nix-plus/blob/main/modules/servers/musescore.nix)



## programs\.musescore\.package



The mcp-musescore package to use\.
...
## programs\.musescore\.passwordCommand
